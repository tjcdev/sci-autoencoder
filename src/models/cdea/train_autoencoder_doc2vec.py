...
train_projects, train_x, test_projects, test_x, train_project_ids, test_project_ids = load_data.load_projects_doc2vec()
...
# Save the model
model_name = 'autoencoder_doc2vec_' + str(embedding_size) + '.h5'
